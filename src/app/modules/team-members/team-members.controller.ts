...
export class TeamMembersController {
  ...
  create(
    ...
    return this.teamMembersService.create(req, createTeamMemberDto, file);
  }
  ...
  findAll(@Query() getTeamMemberDto: GetTeamMemberDto) {
    return this.teamMembersService.findAll(getTeamMemberDto);
  }
  @Get(':id')
